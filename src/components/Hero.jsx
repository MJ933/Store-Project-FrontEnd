      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl md:text-[2.5rem]">
            {t("hero.newSeasonArrivals")}{" "}
            {/* Translation key for "New Season Arrivals" */}
          </h1>
          <p className="mt-4 max-w-md mx-auto text-base text-gray-300">
            {t("hero.discoverCollection")}{" "}
            {/* Translation key for "Discover our curated collection of premium products" */}
          </p>
          <div className="mt-6">
            <button
            ...
            >
              {t("hero.shopNow")} {/* Translation key for "Shop Now" */}
